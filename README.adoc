...
This workshop guides developers through implementing production-ready observability for applications running on OpenShift 4.22.
...
* Monitoring Stack for Red Hat OpenShift 4.22 (Prometheus, Thanos, Alertmanager)
* OpenShift Logging 6.6 (LokiStack, LogQL)
* Tempo Operator 3.9 (distributed tracing)
