...
CLAUDE-SKILLS-GUIDE.md                  # User-facing quick guide (root)
```
...
**Workflow Steps**:
1. Determine context (first vs continuation)
2. Plan overall story (if first)
3. Optional: AgV catalog assistance
4. Gather module details
5. Get UserInfo variables
6. Read templates and verification prompts
7. Generate module content
8. Update navigation
...
**Workflow Steps**:
1. Determine context (new vs continuation)
2. Plan demo narrative and business story
3. Optional: AgV catalog assistance
4. Gather module details
5. Get UserInfo variables
6. Read templates and verification prompts
7. Generate Know/Show structured content
8. Update navigation
...
- Created create-lab, create-demo, verify-content skills
