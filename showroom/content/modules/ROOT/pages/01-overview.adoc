...
image::observability-architecture-overview.png[OpenShift 4.22 Observability Architecture Overview showing Metrics, Logging, and Tracing pillars]

image::overview-challenges.png[Operational challenges (log fragmentation, no distributed tracing, manual correlation) and the opportunity to move to proactive monitoring with the comprehensive observability kit]

== Common questions

**"Do I need to instrument every microservice individually?"**
→ Yes, but Module 3 shows how OpenTelemetry auto-instrumentation reduces the effort significantly
