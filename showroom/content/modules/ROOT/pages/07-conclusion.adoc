...
Congratulations! You've completed all 3 modules of the OpenShift Observability Workshop.
...
* **Module 3**: Distributed tracing with Tempo and OpenTelemetry
...
* Automated application instrumentation with the OpenTelemetry Operator
...
* Deploy and configure the OpenTelemetry Operator and sidecar collectors
...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.22[Monitoring Stack for Red Hat OpenShift documentation^]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/6.6[OpenShift Logging documentation^]
* link:https://docs.redhat.com/en/documentation/red_hat_build_of_opentelemetry/3.9[Red Hat build of OpenTelemetry documentation^]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_distributed_tracing_platform/3.9[Red Hat OpenShift Distributed Tracing Platform documentation^]
