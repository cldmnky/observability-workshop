...
[source,bash]
----
oc rollout status deployment/frontend -n SHOWROOM_USERNAME-observability-demo
oc rollout status deployment/backend -n SHOWROOM_USERNAME-observability-demo
oc rollout status statefulset/database -n SHOWROOM_USERNAME-observability-demo
----
+
[NOTE]
====
