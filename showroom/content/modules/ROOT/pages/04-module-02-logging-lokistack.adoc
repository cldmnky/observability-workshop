...
----
sum by (service) (rate(http_requests_total{code="404", namespace="SHOWROOM_USERNAME-observability-demo}[5m]))
----
+
...
[source,logql,role="copypaste"]
----
{kubernetes_namespace_name="SHOWROOM_USERNAME-observability-demo"} |= "404" |= "error" | json
----
+
  ...
  - name: application-errors
    ...
    - alert: HighApplicationErrorRate
      ...
      labels:
        ...
        team: platform
      annotations:
        summary: "High error rate in SHOWROOM_USERNAME-observability-demo"
        description: "More than 0.5 errors/second for 2 minutes in namespace SHOWROOM_USERNAME-observability-demo."
----
