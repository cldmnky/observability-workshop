...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && db.operation = "INSERT" && .service.name = "database" }
----
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .note.id != "" }
----
+
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .peer.service = "database" && .db.sql.table = "notes" }
----
