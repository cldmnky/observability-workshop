...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .baggage.client.platform = "web" }
----
+
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .baggage.request.source = "workshop-demo" }
----
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .baggage.db.operation = "INSERT" && .baggage.resource.service.name = "database" }
----
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .baggage.note.id != "" }
----
+
...
[source,text,role="copypaste"]
----
{ .k8s.namespace.name = "%OPENSHIFT_USERNAME%-observability-demo" && .baggage.peer.service = "database" && .baggage.db.sql.table = "notes" }
----
