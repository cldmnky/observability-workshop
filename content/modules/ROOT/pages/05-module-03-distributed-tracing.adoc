...
----
NAME                     HOST/PORT                                  
tempo-tempo-jaeger    tempo-tempo-jaeger-openshift-tempo...
----
...
[source,bash]
----
oc get route tempo-tempo-jaeger -n openshift-tempo-operator -o jsonpath='{.spec.host}'
----
+
...
. Verify TempoStack has Jaeger configuration: `oc get tempostack tempo -o yaml | grep jaeger`
