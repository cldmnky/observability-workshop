...
oc exec -n observability-demo prometheus-observability-stack-0 -c prometheus -- \
  ...
  grep -o '"namespace":"[^"]*observability-demo"' | head -5
----
+
.Expected output (showing your namespace is being monitored)
[source,text]
----
...
----
+
If you see your namespace listed, the COO Prometheus has successfully discovered and is scraping your ServiceMonitor.
